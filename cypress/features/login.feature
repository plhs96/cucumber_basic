Feature: Login Functionality
  ...
  Scenario Outline: Login invalid with <type> in sub-domain
    Given The login page in "Sub-domain" site is opened successfull
    When Login with email: "<email>", domain: "" and password: "<password>"
    ...
    Examples: 
      ...
      | organization01@yopmail.com       | 12345679 | The email address or password is incorrect. Please try again.                                                                | incorect email or password |
  ...
  Scenario Outline: Login invalid with <type> in primary-domain
    ...
    Examples: 
      ...
      | organization01@yopmail.com       | Organization STG | 12345679 | The email address or password is incorrect. Please try again.                                                                | incorect email or password         |
      | student29@yopmail.com            |                  | 12345679 | The email address or password is incorrect. Please try again.                                                                | incorect email or password         |
